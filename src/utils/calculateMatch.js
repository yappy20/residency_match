...
// NRMP Match statistics (approximate, based on historical data)
// These represent approximate match rates for couples matching
const MATCH_STATISTICS = {
  // Overall couples match rate is ~85-95% when both specialties are available at same hospitals
  couplesMatchBaseRate: 0.88,
